  ...
  <div class="p-10 bg-[#f8fafc] dark:bg-slate-950 min-h-screen transition-colors duration-300">
    ...
    <div class="max-w-4xl mx-auto mb-8">
      <div class="flex items-center gap-4">
        ...
        <div>
          <h1 class="text-2xl font-black text-slate-900 dark:text-white leading-tight tracking-tight">Create Brand</h1>
          <p class="text-sm text-slate-500 dark:text-slate-400 font-semibold opacity-80">Add a new brand to your collection.</p>
        </div>
      </div>
    </div>
    ...
    <div class="max-w-4xl mx-auto">
      <div class="bg-white dark:bg-slate-900 rounded-[32px] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.06)] dark:shadow-none border border-slate-200/60 dark:border-slate-800 p-8 md:p-12 transition-all">
        <form @submit.prevent="createBrand" class="space-y-10">
...
const createBrand = async () => {
    ...
    try {
        ...
        await createItem('/vendor/attributes/brands', formData)
